...
type GreetServiceClient interface {
	SayHello(ctx context.Context, in *NoParm, opts ...grpc.CallOption) (*HelloResponse, error)
...
func (c *greetServiceClient) SayHello(ctx context.Context, in *NoParm, opts ...grpc.CallOption) (*HelloResponse, error) {
...
func (x *greetServiceSayHelloClientStreamingClient) Send(m *HelloRequst) error {
...
func (x *greetServiceSayHelloBidirectionalStreamingClient) Send(m *HelloRequst) error {
	return x.ClientStream.SendMsg(m)
}
...
type GreetServiceServer interface {
	SayHello(context.Context, *NoParm) (*HelloResponse, error)
...
func (UnimplementedGreetServiceServer) SayHello(context.Context, *NoParm) (*HelloResponse, error) {
...
func _GreetService_SayHello_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(GreetServiceServer).SayHello(ctx, req.(*NoParm))
	}
...
func (x *greetServiceSayHelloClientStreamingServer) Recv() (*HelloRequst, error) {
	m := new(HelloRequst)
...
func (x *greetServiceSayHelloBidirectionalStreamingServer) Recv() (*HelloRequst, error) {
	m := new(HelloRequst)
	if err := x.ServerStream.RecvMsg(m); err != nil {
		return nil, err
	}
